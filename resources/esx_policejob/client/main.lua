...
function OpenCloakroomMenu()
	...
	if Config.EnableNonFreemodePeds then
		...
		table.insert(elements, {label = 'Detective Wear', value = 'freemode_ped', maleModel = 's_m_m_ciasec_01'})
		table.insert(elements, {label = 'CHP Wear', value = 'freemode_ped', maleModel = 's_m_y_hwaycop_01'})
	end
