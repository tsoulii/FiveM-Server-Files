...
AddEventHandler('_chat:messageEntered', function(author, color, message)
    ...
    if not WasEventCanceled() then
		...
		elseif vRP.hasGroup({user_id,"cop"}) then
			TriggerClientEvent('chatMessage', -1, "^4POLICE ^7| " .. author .. ": ^4" ..  message)
		...
		elseif vRP.hasGroup({user_id,"user"}) then
			TriggerClientEvent('chatMessage', -1, "^3CIVILIAN ^7| " .. author .. ": ^3" ..  message)
		else
