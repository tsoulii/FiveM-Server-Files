...
local keyParam = Keys["N"] -- e.g : Keys["H"] will be change the U key to the H key for lock/unlock a vehicle
local soundEnable = true -- Set to false for disable sounds
local disableCar_NPC = false -- Set to false for enable NPC's car
local soundDistance = 5 -- Distance of sounds lock / unlock (default: 10m)
