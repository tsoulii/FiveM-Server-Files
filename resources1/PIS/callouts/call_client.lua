...
AddEventHandler('pis:shoplifting', function()
	...
	local ClerkAgressiveQuotes = {"Get back here, you fucker!!", "Officer! Thats the fucker", "That fucker took my shit!", "Motherfucker, get the fuck back here!", "Shoot that bitch!", "I'm going to fucking kill him!"}
