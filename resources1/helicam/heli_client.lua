...
Citizen.CreateThread(function()
	while true do
		...
		if IsPlayerInPolmav() then
			...
			if IsControlJustPressed(0, toggle_spotlight) and GetLastInputMethod( 0 ) and GetPedInVehicleSeat(heli, -1) == lPed and not helicam then -- Toggle forward and tracking spotlight states
