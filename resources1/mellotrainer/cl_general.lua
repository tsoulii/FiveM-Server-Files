...
Citizen.CreateThread( function()
	while true do
		...
		if ( IsControlJustReleased( 0, 168 ) or IsDisabledControlJustReleased( 0, 168 ) ) and GetLastInputMethod( 0 ) and ((settings["adminOnlyNoclip"] == true and adminStatus == true) or settings["adminOnlyNoclip"] == false) then
			toggleNoClipMode()
		end
